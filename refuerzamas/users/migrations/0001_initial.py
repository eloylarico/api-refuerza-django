    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_usuario', models.CharField(choices=[('ESTUDIANTE', 'Estudiante'), ('PROFESOR', 'Profesor')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foto', models.ImageField(null=True, upload_to='usuarios/niveles', verbose_name='Icono del nivel')),
            ],
            options={
                'verbose_name': 'Nivel',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('docente', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='users.Docente', verbose_name='Horarios Libres del Docente')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ciclo_universidad', models.IntegerField(blank=True, default=0, null=True)),
                ('grado_colegio', models.IntegerField(blank=True, default=0, null=True)),
